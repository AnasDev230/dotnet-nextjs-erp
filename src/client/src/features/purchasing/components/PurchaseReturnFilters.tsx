...
const statusOptionKeys = [
  { value: "Draft", labelKey: "returns.status.draft" },
  { value: "Submitted", labelKey: "returns.status.submitted" },
  { value: "Approved", labelKey: "returns.status.approved" },
  { value: "Completed", labelKey: "returns.status.completed" },
  { value: "Cancelled", labelKey: "returns.status.cancelled" },
];
...
export default function PurchaseReturnFilters() {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      <div className="relative flex-1 min-w-[200px]">
        ...
        <Input
          placeholder={t("returns.searchPlaceholderPurchase")}
