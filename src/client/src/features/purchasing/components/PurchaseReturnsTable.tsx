...
import { useDeletePurchaseReturn } from "../hooks/usePurchaseReturns";
        ...
        <Table>
          ...
          <TableBody>
            {purchaseReturns.map((purchaseReturn) => (
              <TableRow key={purchaseReturn.id} className="hover:bg-muted/30 transition-colors">
                ...
                <TableCell className="px-4 py-3 text-sm text-muted-foreground">
                  {formatDate(purchaseReturn.returnDate, language)}
                </TableCell>
                <TableCell className="px-4 py-3 text-sm tabular-nums">
                  {formatCurrency(purchaseReturn.totalAmount, language)}
                </TableCell>
                <TableCell className="px-4 py-3">
                  <ReturnStatusBadge status={purchaseReturn.status} />
                </TableCell>
                <TableCell className="px-4 py-3 text-end">
                  <div className="flex items-center justify-end gap-1">
                    <Link href={`/purchasing/returns/${purchaseReturn.id}`}>
