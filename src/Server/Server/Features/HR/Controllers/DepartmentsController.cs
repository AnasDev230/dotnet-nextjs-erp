...
public class DepartmentsController : ControllerBase
{
        ...
        [FromQuery] bool? isActive = null)
    {
        ...
        return Ok(ApiResponse<PagedResult<DepartmentListItemResponse>>.SuccessResult(result));
    }
    ...
    public async Task<IActionResult> GetForDropdown()
    {
        ...
        return Ok(ApiResponse<List<DepartmentListItemResponse>>.SuccessResult(result));
    }
    ...
    public async Task<IActionResult> GetById(Guid id)
    {
        ...
        return Ok(ApiResponse<DepartmentResponse>.SuccessResult(result));
    }
    ...
    public async Task<IActionResult> Create([FromBody] CreateDepartmentRequest request)
    {
        ...
        return CreatedAtAction(nameof(GetById), new { id = result.Id }, ApiResponse<DepartmentResponse>.SuccessResult(result));
    }
    ...
    public async Task<IActionResult> Delete(Guid id)
    {
        ...
        return Ok(ApiResponse<string>.SuccessResult("Department deleted successfully"));
    }
}